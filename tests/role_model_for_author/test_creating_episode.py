...
@allure.story('Создание эпизода с публикацией')
@allure.title('Создание эпизода с публикацией')
@allure.suite('UI Тесты')
def test_creating_episode(creating_podcast_api, podcaster_cabinet, deleting_all_authors):
